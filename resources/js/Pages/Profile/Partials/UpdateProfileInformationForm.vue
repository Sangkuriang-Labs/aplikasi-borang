...
<template>
  <FormSection @submitted="updateProfileInformation">
    ...
    <template #description> Pembaharuan informasi pribadi akun anda. </template>
      ...
      <div class="col-span-6 sm:col-span-4">
        ...
        >
          <p class="mt-2 text-sm">
            ...
            >
              Klik disini untuk melakukan verifikasi ulang email.
            </Link>
          </p>
          ...
          >
            Link email verifikasi telah terkirim ke alamat email anda.
          </div>
        </div>
      </div>
    </template>
